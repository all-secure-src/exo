      ...
      <header className="sticky top-0 z-50 flex items-center justify-between w-full px-4 border-b h-14 shrink-0 dark:bg-slate-800 bg-white backdrop-blur-xl">
        <span className="inline-flex items-center home-links whitespace-nowrap">
          <a rel="noopener">
            ...
            {/* <span className="block sm:inline text-lg sm:text-xl lg:text-2xl font-semibold dark:text-white text-black">EXO <span className="linear-wipe">engine</span></span> */}
          </a>
        </span>
        <div className="flex items-center justify-end space-x-2">
            <a
              rel="noopener noreferrer"
              className="bg-gray-100 dark:bg-white-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-black dark:text-white font-semibold rounded shadow"
            >
              <img src="./powered-by-omega.svg" alt="omega logo" className="w-20" />
            </a>
        </div>
      </header>
