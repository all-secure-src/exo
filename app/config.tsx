...
export const config = {
    ...
    inferenceModel: 'qxsecureserver/mdl-4-0-wz-2-mx', // Groq: 'mixtral-8x7b-32768', 'gemma-7b-it' // OpenAI: 'gpt-3.5-turbo', 'gpt-4' // Ollama 'mistral', 'llama2' etc
    ...
    nonOllamaBaseURL: 'https://uj51ls6jlmb85m-80.proxy.runpod.net/v1', //Groq: https://api.groq.com/openai/v1 // OpenAI: https://api.openai.com/v1 
